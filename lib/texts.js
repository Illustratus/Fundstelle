...
export const TEXTS = {
  de: {
    ...
    errorOperationsList: "Beeinträchtigte Operationen werden als Liste erwartet",
    ...
    catalogLead:
      ...
      "befragten Bereiche die Anforderung ansprechen; „beeinträchtigt“ nennt die " +
    ...
    // A pillar about which the material says nothing. Written out rather than
    // left away: a pillar left out and a pillar shown to be empty read the same
    // on paper and are not the same finding.
    roleProfileOpen: "offen",
